...
const defaultHotelState = {
  ...
  rooms: [
    { id: "101", name: "Habitacion Estandar", type: "Doble", floor: 1, capacity: 2, price: 80, status: "available", imageUrl: defaultRoomImages[101], view: "Vista al mar", beds: "1 cama king", amenities: ["Wifi", "Aire acondicionado", "Desayuno"] },
    { id: "102", name: "Habitacion Deluxe", type: "Individual", floor: 1, capacity: 1, price: 55, status: "available", imageUrl: defaultRoomImages[102], view: "Vista al jardin", beds: "1 cama individual", amenities: ["Wifi", "Minibar", "Escritorio"] },
    { id: "103", name: "Habitacion Twin", type: "Doble", floor: 1, capacity: 2, price: 90, status: "available", imageUrl: defaultRoomImages[103], view: "Vista piscina", beds: "2 camas individuales", amenities: ["Wifi", "Smart TV", "Desayuno"] },
    { id: "104", name: "Habitacion Accesible", type: "Doble", floor: 1, capacity: 2, price: 75, status: "available", imageUrl: defaultRoomImages[104], view: "Vista jardin", beds: "1 cama queen", amenities: ["Wifi", "Ducha accesible", "Aire acondicionado"] },
    { id: "201", name: "Suite Familiar", type: "Suite", floor: 2, capacity: 4, price: 60, status: "available", imageUrl: defaultRoomImages[201], view: "Vista panoramica", beds: "2 camas dobles", amenities: ["Wifi", "Sala", "Desayuno"] },
    { id: "202", name: "Habitacion Ejecutiva", type: "Doble", floor: 2, capacity: 2, price: 78, status: "maintenance", imageUrl: defaultRoomImages[202], view: "Vista ciudad", beds: "1 cama queen", amenities: ["Wifi", "Aire acondicionado", "Caja fuerte"] },
    { id: "203", name: "Suite Junior", type: "Suite", floor: 2, capacity: 3, price: 95, status: "available", imageUrl: defaultRoomImages[203], view: "Vista ciudad", beds: "1 cama king y sofa cama", amenities: ["Wifi", "Sala", "Minibar"] },
    { id: "204", name: "Habitacion Premium", type: "Doble", floor: 2, capacity: 2, price: 105, status: "available", imageUrl: defaultRoomImages[204], view: "Vista al mar", beds: "1 cama king", amenities: ["Wifi", "Balcon", "Cafetera"] },
    { id: "301", name: "Suite Presidencial", type: "Suite", floor: 3, capacity: 4, price: 120, status: "available", imageUrl: defaultRoomImages[301], view: "Vista panoramica", beds: "1 cama king y 2 individuales", amenities: ["Wifi", "Jacuzzi", "Sala privada"] },
    { id: "302", name: "Habitacion Ejecutiva Plus", type: "Doble", floor: 3, capacity: 2, price: 69, status: "available", imageUrl: defaultRoomImages[302], view: "Vista ciudad", beds: "1 cama king", amenities: ["Wifi", "Escritorio", "Caja fuerte"] },
    { id: "303", name: "Habitacion Individual Confort", type: "Individual", floor: 3, capacity: 1, price: 99, status: "available", imageUrl: defaultRoomImages[303], view: "Vista interna", beds: "1 cama individual", amenities: ["Wifi", "Escritorio", "Smart TV"] },
    { id: "304", name: "Suite Universitaria", type: "Suite", floor: 3, capacity: 5, price: 100, status: "available", imageUrl: defaultRoomImages[304], view: "Vista campus", beds: "2 camas queen y sofa cama", amenities: ["Wifi", "Comedor", "Desayuno"] }
  ],
  reservations: [],
  checkIns: [],
  checkOuts: []
